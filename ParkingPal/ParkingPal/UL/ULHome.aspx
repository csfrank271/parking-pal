    ...
    <div class="center">
        ...
        <div class="col row s12 m6">
            ...
            <div class="col s12 m3">
                <asp:Button runat="server" class="btn-large" style="font-family: Arial, FontAwesome" onClick="extendTicket" Text="Extend Ticket"  ClientIDMode="AutoID"/>  
            </div>
        </div>
          
    <br /> 
    <div>
        <div class="col s12 m12" id="bar-graph"></div>
    </div>
    </div>
</asp:Content>
